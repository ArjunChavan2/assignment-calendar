...
const APP_CONFIG = {
  ...
  assignments: [
    ...
    { id: "270-p3-signoff", name: "Project 3 Signoff", course: "eecs270", due: "2026-03-02", time: "11:59 PM", type: "project", points: "5", hours: 0.5 },
    { id: "270-p4", name: "Project 4: Timing and Delay", course: "eecs270", due: "2026-02-27", time: "11:59 PM", type: "project", points: "40", hours: 6, specUrl: "https://umich.instructure.com/courses/815882/pages/project-4-timing-and-delay" },
    ...
    { id: "270-q3", name: "Quiz 3 (Pos. Binary Nums)", course: "eecs270", due: "2026-01-22", time: "11:59 PM", type: "quiz", points: "20", hours: 1.5 },
    { id: "270-q4", name: "Quiz 4 (Binary Arith.)", course: "eecs270", due: "2026-01-29", time: "11:59 PM", type: "quiz", points: "29", hours: 1.5 },
    { id: "270-q5", name: "Quiz 5 (Combo. Blocks)", course: "eecs270", due: "2026-02-05", time: "11:59 PM", type: "quiz", points: "22", hours: 1.5 },
    { id: "270-q6", name: "Quiz 6 (2-Level Logic)", course: "eecs270", due: "2026-02-12", time: "11:59 PM", type: "quiz", points: "21", hours: 1.5 },
    { id: "270-q7", name: "Quiz 7 (Timing & Delay)", course: "eecs270", due: "2026-02-19", time: "11:59 PM", type: "quiz", points: "20", hours: 1.5 },
    ...
    // EECS 270
    { id: "270-welcome-to-eecs-270-", name: "Welcome to EECS 270: Introduction to Logic Design!", course: "eecs270", due: "2026-01-06", time: "4:10 PM", type: "assignment", points: "—", hours: 1 },
    // ===== EECS 370 - Projects =====
    ...
    { id: "370-p1s", name: "Project 1s: Simulator", course: "eecs370", due: "2026-02-05", time: "11:55 PM", type: "project", points: "40", hours: 8, specUrl: "https://eecs370.github.io/project_1_spec" },
    { id: "370-p2a", name: "Project 2a: Assembler", course: "eecs370", due: "2026-02-19", time: "11:55 PM", type: "project", points: "35", hours: 8, specUrl: "https://eecs370.github.io/project_2_spec" },
    ...
    { id: "370-hw2", name: "Homework 2", course: "eecs370", due: "2026-02-23", time: "11:55 PM", type: "homework", points: "100", hours: 6, specUrl: "https://eecs370.github.io/homework/index.html" },
    ...
    // EECS 370 - Exams
    { id: "370-midterm", name: "Midterm Exam", course: "eecs370", due: "2026-02-24", time: "11:42 AM", type: "exam", points: "100", hours: 12 },
    { id: "370-final", name: "Final Exam", course: "eecs370", due: "2026-04-23", time: "10:30 AM", type: "exam", points: "100", hours: 15 },
    { id: "370-exam", name: "** Exam Conflict Form**", course: "eecs370", due: "2026-01-12", time: "12:06 PM", type: "exam", points: "—", hours: 12 },
    // EECS 370
    { id: "370-lectures-at-12pm-and", name: "Lectures at 12pm and 3pm cancelled for 1/27", course: "eecs370", due: "2026-01-27", time: "10:44 AM", type: "assignment", points: "—", hours: 1 },
    { id: "370-dr-brehob-s-sections", name: "Dr. Brehob's sections on Thursday 1/29", course: "eecs370", due: "2026-01-28", time: "3:28 PM", type: "assignment", points: "—", hours: 1 },
    // ===== EECS 442 - Homeworks =====
    ...
    { id: "s250-ep03", name: "EP 03", course: "stats250", due: "2026-02-06", time: "2:30 PM", type: "ep", points: "40", hours: 2 },
    ...
    { id: "tc-w2", name: "Week 2 - Evidence Language Activity", course: "tc300", due: "2026-01-15", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-w3", name: "Week 3 - Cover Letter Group", course: "tc300", due: "2026-01-22", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-resume-draft", name: "Resume Draft", course: "tc300", due: "2026-01-23", time: "11:59 PM", type: "assignment", points: "10", hours: 3 },
    ...
    { id: "tc-w6", name: "Week 6 - Structure & Org", course: "tc300", due: "2026-02-12", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-topic-proposal", name: "Written Report Topic Proposal", course: "tc300", due: "2026-02-13", time: "11:59 PM", type: "assignment", points: "10", hours: 2 },
    ...
    { id: "tc-bring-resume-to-class-1-15-not", name: "Bring Resume to Class 1/15 + Note for New Folks", course: "tc300", due: "2026-01-14", time: "11:30 AM", type: "assignment", points: "—", hours: 1 },
    { id: "tc-week-2-evidence-language-in-cl", name: "Week 2 - Evidence Language In Class Activity", course: "tc300", due: "2026-01-15", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-pre-course-survey-required", name: "Pre-Course Survey (Required)", course: "tc300", due: "2026-01-16", time: "11:59 PM", type: "assignment", points: "1", hours: 1 },
    { id: "tc-office-hours-on-zoom-today-1-2", name: "Office Hours on Zoom Today 1/21", course: "tc300", due: "2026-01-21", time: "10:20 AM", type: "assignment", points: "—", hours: 1 },
    { id: "tc-week-3-cover-letter-group-acti", name: "Week 3 - Cover Letter Group Activity ", course: "tc300", due: "2026-01-22", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-cover-letter-draft", name: "Cover Letter Draft ", course: "tc300", due: "2026-01-23", time: "11:59 PM", type: "assignment", points: "10", hours: 1 },
    { id: "tc-annotated-job-ad", name: "Annotated Job Ad", course: "tc300", due: "2026-01-23", time: "11:59 PM", type: "assignment", points: "10", hours: 1 },
    { id: "tc-reiterating-expectations-for-c", name: "Reiterating Expectations for Career Documents Portfolio", course: "tc300", due: "2026-01-29", time: "6:05 PM", type: "assignment", points: "—", hours: 1 },
    { id: "tc-week-4-star-method-worksheet", name: "Week 4 - STAR Method Worksheet", course: "tc300", due: "2026-01-29", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-week-5-revision-group-activity", name: "Week 5 - Revision Group Activity", course: "tc300", due: "2026-02-05", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-career-documents-portfolio-ref", name: "Career Documents Portfolio- Reflection Questions", course: "tc300", due: "2026-02-06", time: "11:59 PM", type: "assignment", points: "30", hours: 1 },
    { id: "tc-revised-cover-letter", name: "Revised Cover Letter", course: "tc300", due: "2026-02-06", time: "11:59 PM", type: "assignment", points: "20", hours: 1 },
    { id: "tc-week-6-structure-and-organizat", name: "Week 6 - Structure and Organization", course: "tc300", due: "2026-02-12", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-written-report-topic-proposal", name: "Written Report Topic Proposal", course: "tc300", due: "2026-02-13", time: "11:59 PM", type: "assignment", points: "10", hours: 1 },
    { id: "tc-report-outline-assignment-post", name: "Report Outline Assignment Posted", course: "tc300", due: "2026-02-16", time: "11:34 AM", type: "assignment", points: "—", hours: 1 },
    { id: "tc-week-7-critically-reading-acad", name: "Week 7 - Critically Reading Academic Articles Group Activity", course: "tc300", due: "2026-02-19", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-week-8-effective-data-visualiz", name: "Week 8 - Effective Data Visualization Activity", course: "tc300", due: "2026-02-26", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-written-report-outline", name: "Written Report Outline", course: "tc300", due: "2026-02-27", time: "11:59 PM", type: "assignment", points: "20", hours: 1 },
    { id: "tc-week-10-presentation-delivery", name: "Week 10 - Presentation Delivery ", course: "tc300", due: "2026-03-12", time: "11:59 PM", type: "assignment", points: "2", hours: 1 },
    { id: "tc-written-report-draft", name: "Written Report Draft", course: "tc300", due: "2026-03-19", time: "11:30 AM", type: "assignment", points: "30", hours: 1 },
    { id: "tc-oral-report-topic-proposal", name: "Oral Report Topic Proposal", course: "tc300", due: "2026-03-20", time: "11:59 PM", type: "assignment", points: "5", hours: 1 },
    { id: "tc-oral-presentation-draft-slides", name: "Oral Presentation Draft Slides ", course: "tc300", due: "2026-04-02", time: "11:30 AM", type: "assignment", points: "10", hours: 1 },
    { id: "tc-extra-credit-assignment-famili", name: "Extra Credit Assignment - Familiarizing with OriginPro", course: "tc300", due: "2026-04-24", time: "11:59 PM", type: "assignment", points: "0", hours: 1 },
    // TCHNCLCM 300 - Labs
    { id: "tc-syllabus-agreement", name: "Syllabus Agreement", course: "tc300", due: "2026-01-16", time: "11:59 PM", type: "lab", points: "2", hours: 1.5 },
    // TCHNCLCM 300 - Exams
    { id: "tc-final-written-report", name: "Final Written Report", course: "tc300", due: "2026-04-02", time: "11:30 AM", type: "exam", points: "75", hours: 12 },
  ],
