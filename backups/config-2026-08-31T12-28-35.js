...
const APP_CONFIG = {
  ...
  assignments: [
    ...
    },
    {
      ...
      workPlan: [
        { date: "2026-01-20", task: "Read spec: LC-2K ISA, instruction formats, label rules, error types", hours: 2 },
        { date: "2026-01-22", task: "First pass: scan labels and assign memory addresses", hours: 2 },
        { date: "2026-01-24", task: "Second pass: generate 32-bit machine code for each instruction type", hours: 2 },
        { date: "2026-01-27", task: "Implement all 6 error detections, write test suite (6+ .as files)", hours: 1.5 },
        { date: "2026-01-28", task: "Final debugging, test against autograder examples", hours: 0.5 }
      ]
    },
    {
      id: "370-p1m",
      ...
      specUrl: "https://eecs370.github.io/project_1_spec",
      workPlan: [
        { date: "2026-01-30", task: "Design shift-and-add algorithm on paper, plan loop structure", hours: 1 },
        { date: "2026-02-02", task: "Write mult.as: implement loop, test with 6203×1429, verify ≤50 lines ≤1000 cycles", hours: 2 },
        { date: "2026-02-04", task: "Debug edge cases (zero inputs), assemble and simulate end-to-end", hours: 1 }
      ]
    },
    {
      id: "370-p1s",
      ...
      specUrl: "https://eecs370.github.io/project_1_spec",
      workPlan: [
        { date: "2026-01-27", task: "Read simulator spec: processor state, print format, instruction execution", hours: 1.5 },
        { date: "2026-01-29", task: "Parse hex .mc input, initialize registers/memory/PC, implement fetch-decode loop", hours: 2 },
        { date: "2026-01-31", task: "Implement all instruction handlers (add, nand, lw, sw, beq, jalr, halt, noop)", hours: 2 },
        { date: "2026-02-03", task: "Write 6+ test cases covering all instructions, verify ≤200 cycles each", hours: 1.5 },
        { date: "2026-02-04", task: "Final testing with assembler output, cross-check against spec", hours: 1 }
      ]
    },
    {
      id: "370-p2a",
      ...
      workPlan: [
        { date: "2026-02-10", task: "Read spec: understand .as format, object file sections, label rules", hours: 2 },
        { date: "2026-02-11", task: "Implement lexer/parser: tokenize instructions, extract labels & opcodes", hours: 2 },
        { date: "2026-02-13", task: "Build symbol table: local vs global labels, undefined external refs", hours: 2 },
        { date: "2026-02-16", task: "Generate output: header, text segment, data segment, relocation table", hours: 1.5 },
        { date: "2026-02-18", task: "Error detection, write test suite (.as files), final debugging", hours: 0.5 }
      ]
    },
    {
      id: "370-p2l",
      ...
      specUrl: "https://eecs370.github.io/project_2_spec",
      workPlan: [
        { date: "2026-03-10", task: "Read linker spec: understand .obj format from 2a, plan data structures", hours: 2 },
        { date: "2026-03-12", task: "Parse all input .obj files, concatenate text and data segments", hours: 2 },
        { date: "2026-03-14", task: "Resolve symbol table across files: global/local merging, Stack label offset", hours: 2.5 },
        { date: "2026-03-17", task: "Apply relocation table: patch text segment addresses, output .mc file", hours: 2 },
        { date: "2026-03-18", task: "Error checking (duplicate globals, unresolved refs), multi-file test cases", hours: 1.5 }
      ]
    },
    {
      id: "370-p2r",
      ...
      specUrl: "https://eecs370.github.io/project_2_spec",
      workPlan: [
        { date: "2026-03-14", task: "Review combination C(n,r) math, plan stack frame and register layout", hours: 1 },
        { date: "2026-03-16", task: "Write recursive.as: base cases, recursive calls, arg/return via stack", hours: 2 },
        { date: "2026-03-18", task: "Debug with Project 1 simulator, verify register conventions, ≤80 lines", hours: 2 }
      ]
    },
    {
      id: "370-p3-cp",
  ...
  autoCompleted: [
    ...
    "s250-exam2",
    "s250-l14gw",
    // Auto-added 2026-03-23: past assignments (due before 2026-03-21) not previously marked
    "tc-report-draft",
    "tc-oral-proposal",
    ...
    "442-q11",
    "370-hw3",
    // Auto-added 2026-03-28: past assignments (due before 2026-03-26) not previously marked
    "270-exam2",
    "442-q12",
    "s250-l16pw",
    "s250-l16gw",
    ...
    "370-pl10",
    "tc-w13",
    // Auto-added 2026-04-06: past assignments (due on/before 2026-04-03) not previously marked
    "tc-oral-slides",
    "tc-final-report",
    "270-q15",
    "s250-ep08",
    "s250-lab7",
    // Auto-added 2026-04-09: past assignments (due on/before 2026-04-07) not previously marked
    "s250-l19pw",
    "s250-l19gw",
    // Auto-added 2026-04-12: past assignments (due on/before 2026-04-09) not previously marked
    "370-pl11",
    "442-hw5",
    "tc-final-oral-presentation",
    // Auto-added 2026-04-13: past assignments (due on/before 2026-04-11) not previously marked
    "270-p7-cp",
    "s250-ep09",
    "s250-cs3",
    ...
    "s250-l22pw",
    "s250-l22gw",
    // Auto-added 2026-04-25 (scrape): past assignments (due on/before 2026-04-22) not previously marked
    "270-p6-signoff",
    "270-p7",
    "370-hw4",
    "s250-ec-mod0"
